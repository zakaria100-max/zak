    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module_id', models.CharField(max_length=64, null=True, unique=True, verbose_name='Module ID')),
                ('module', models.CharField(max_length=128, verbose_name='Modulname')),
                ('module_wahl', models.CharField(blank=True, choices=[('soa', 'SOA'), ('WPR', ' WPR'), ('ALGEBRA', 'ALGEBRA'), ('ALNALSIS', 'ALNALSIS'), ('JAVA', 'JAVA'), ('WIRTSCHAFTSINFORMATIK', 'WIRTSCHAFTSINFORMATIK'), ('BWL', 'BWL')], max_length=100, verbose_name='Fach')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('owner_id', models.CharField(max_length=64, null=True, unique=True, verbose_name='Studenten_ID')),
                ...
                ('student_profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='owners', to='module.Module', verbose_name='Module')),
            ],
            options={
